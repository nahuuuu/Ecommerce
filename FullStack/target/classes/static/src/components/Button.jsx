...
const Button = ({className,type, text, ruta,b,isHovered,buttonExpand,buttonExpandMin,buttonExpandMax,onMouseLeave,onMouseEnter }) => { 
  buttonExpand="";
  b="";
  let buttonStyle = {};
...
y al verificarlo ejecutamos la funcion pasandola como prop*/
  ...
  return (
    <button 
      className={`${buttonExpand} ${b} ${className} button`} 
