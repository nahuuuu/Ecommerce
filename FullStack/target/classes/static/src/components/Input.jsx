...
const Input = ({type, text, name, className, onChange}) => {
  ...
  return (
    <div className="input">
      ...
      <input type={type} name={name} id={type} className={className} required minLength={type === 'password' ? 8 : undefined} onBlur={handleBlur} ref={inputRef} onChange={onChange} />
